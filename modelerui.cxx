...
/*
should or should not play with fluid ?
trivial question, ignore it..
*/
...
inline void ModelerUserInterface::cb_m_controlsWindow_i(Fl_Window*, void*) {
  ...
  // don't understand
  0;
  // or that's because this file is generated by fluid?
}
...
ModelerUserInterface::ModelerUserInterface() {
  ...
  Fl_Window* w;
  { 
    Fl_Window* o = m_controlsWindow = new Fl_Window(445, 326, "COMP4411 Modeler");
    w = o;
    o->callback((Fl_Callback*)cb_m_controlsWindow, (void*)(this));
    o->when(FL_WHEN_NEVER);
    // the condition under which the callback is called
    { 
        Fl_Menu_Bar* o = m_controlsMenuBar = new Fl_Menu_Bar(0, 0, 445, 25);
    ...
    { 
        Fl_Scroll* o = m_controlsScroll = new Fl_Scroll(145, 25, 300, 300);
        o->type(6);
        o->when(FL_WHEN_CHANGED);
        { 
            Fl_Pack* o = m_controlsPack = new Fl_Pack(145, 25, 275, 300);
            o->end();
        }
        o->end();
    }
